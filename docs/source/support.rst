...
This python module is open source, under `GPLv3 <https://github.com/MatteoGuadrini/vmam/blob/master/LICENSE.md>`_ license.
Anyone who wants, passion, respect and love can contribute to this project, for himself and for all of humanity.

Contribute
**********

If you wanted to contribute to this python module, `fork <https://github.com/MatteoGuadrini/vmam>`_.
...
.. raw:: html
    ...
    <a class="github-button" href="https://github.com/matteoguadrini/vmam" data-icon="octicon-star" data-show-count="true" aria-label="Star matteoguadrini/vmam on GitHub">Star</a>
    <!-- Place this tag where you want the button to render. -->
    <a class="github-button" href="https://github.com/matteoguadrini/vmam/fork" data-icon="octicon-repo-forked" data-show-count="true" aria-label="Fork matteoguadrini/vmam on GitHub">Fork</a>
    <br>
    <br>
...
.. raw:: html
    ...
    <script async defer src="https://buttons.github.io/buttons.js"></script>
    <!-- Place this tag where you want the button to render. -->
    <a class="github-button" href="https://github.com/matteoguadrini/vmam/issues" data-icon="octicon-issue-opened" data-show-count="true" aria-label="Issue matteoguadrini/vmam on GitHub">Issue</a>
    <br>
    <br>
